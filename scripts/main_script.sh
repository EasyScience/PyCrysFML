...
echo ""
echo ":::::::::::::::::::::::::::::::::::::::::"
echo ":: Creating CrysFML2008 static library ::"
echo ":::::::::::::::::::::::::::::::::::::::::"
echo "- Deleting build dir 'crysfml08_repo'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo
echo "- Creating build dir 'crysfml08_repo'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo
echo "- Downloading CrysFML2008 branch 'nagfor' to 'crysfml08_repo' from 'https://code.ill.fr/rodriguez-carvajal/crysfml2008.git'"
git clone --single-branch --branch nagfor https://code.ill.fr/rodriguez-carvajal/crysfml2008.git /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo
echo "- Deleting build dir 'crysfml08_build'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_build
echo "- Creating build dir 'crysfml08_build'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_build
...
echo "- Entering build dir 'crysfml08_build'"
cd /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_build
echo "- Creating fortran static library 'libCrysFML08.a'"
ar -r libCrysFML08.a *.o
echo "- Exiting build dir 'crysfml08_build'"
cd /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML
echo "- Deleting dist dir 'crysfml08_dist'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_dist
echo "- Creating dist dir 'crysfml08_dist'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_dist
echo "- Creating dist dir 'crysfml08_dist/lib'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_dist/lib
echo "- Creating dist dir 'crysfml08_dist/include'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_dist/include
...
echo ""
echo "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
echo ":: Creating PyCrysFML08 shared objects or dynamic libraries ::"
echo "::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::"
echo "- Deleting build dir 'pycrysfml08_repo'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo
echo "- Creating build dir 'pycrysfml08_repo'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo
echo "- Downloading PyCrysFML08 branch 'master' to 'pycrysfml08_repo' from 'https://code.ill.fr/scientific-software/pycrysfml08.git'"
git clone --single-branch --branch master https://code.ill.fr/scientific-software/pycrysfml08.git /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo
echo "- Copying 'Testing/Powder/Test_2/fortran/src/powder_mod.F90' to 'pycrysfml08_repo/src'"
cp /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo/Testing/Powder/Test_2/fortran/src/powder_mod.F90 /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo/src
echo "- Copying 'Testing/Powder/Test_3/powder_mod_2.F90' to 'pycrysfml08_repo/src'"
cp /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo/Testing/Powder/Test_3/powder_mod_2.F90 /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo/src
echo "- Deleting build dir 'pycrysfml08_build'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_build
echo "- Creating build dir 'pycrysfml08_build'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_build
...
echo "- Exiting build dir 'pycrysfml08_build'"
cd /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML
echo "- Deleting dist dir 'pycrysfml08_dist'"
rm -rf /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist
echo "- Creating dist dir 'pycrysfml08_dist/pycrysfml08'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist/pycrysfml08
echo "- Copying compiled PyCrysFML08 shared objects or dynamic libs to 'pycrysfml08_dist/pycrysfml08'"
cp /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_build/*.so /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist/pycrysfml08
echo ""
echo ":::::::::::::::::::::::::::::::::::::::::::::::"
echo ":: Creating PyCrysFML08 python package wheel ::"
echo ":::::::::::::::::::::::::::::::::::::::::::::::"
echo "- Copying PyCrysFML08 '__init__.py' to dist dir 'pycrysfml08_dist/pycrysfml08'"
cp /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_repo/pycrysfml08/__init__.py /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist/pycrysfml08
echo "- Creating dir 'pycrysfml08_dist/pycrysfml08/Databases'"
mkdir -p /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist/pycrysfml08/Databases
echo "- Copying 'crysfml08_repo/Src/Databases/magnetic_data.txt' database to dist dir 'pycrysfml08_dist/pycrysfml08/Databases'"
cp /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/crysfml08_repo/Src/Databases/magnetic_data.txt /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_dist/pycrysfml08/Databases
echo "- Validating pyproject.toml"
validate-pyproject pyproject.toml
echo "- Creating 'PyCrysFML08' python wheel in 'pycrysfml08_wheel'"
python3 -m build --wheel --outdir /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_wheel
echo ""
echo "::::::::::::::::::::::::::::::::::::::::::::::"
echo ":: Installing PyCrysFML08 from python wheel ::"
echo "::::::::::::::::::::::::::::::::::::::::::::::"
echo "- Installing 'PyCrysFML08' python wheel from 'pycrysfml08_wheel'"
python3 -m pip install "pycrysfml08[dev]" --force-reinstall --find-links=/Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/pycrysfml08_wheel
echo ""
echo ":::::::::::::::::::::::::::::::"
echo ":: Running PyCrysFML08 tests ::"
echo ":::::::::::::::::::::::::::::::"
echo "- Running unit tests from 'tests/unit_tests'"
pytest /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/tests/unit_tests -v
echo "- Running powder_mod tests from 'tests/powder_mod_tests'"
pytest /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/tests/powder_mod_tests -v
echo "- Running powder_mod main from 'tests/powder_mod_tests/test_powder_mod.py'"
python3 /Users/andrewsazonov/Development/github.com/AndrewSazonov/TEST_PyCrysFML/tests/powder_mod_tests/test_powder_mod.py
